...
class AppTexts {
  ...
  static const Map<String, String> _tr = {
    ...
    'howItWorksSubtitle': 'Uygulamanın önemli özelliklerini öğren.',
    ...
    'aiChatMenuShare': 'Paylaş',
    'aiChatMenuCopy': 'Kopyasını oluştur',
    ...
    'aiChatDeveloperOnly': 'Yapay zeka görüşmesi geliştirici sürümünde kullanılabilir',
    ...
    'permissionWhyThisTooltip': 'Bu izin neden gerekli?',
    ...
    'breathExerciseCardTitle': 'Nefes Testi',
    ...
    'breathTestRecordTitle': 'Nefes Testi Kaydı',
    ...
    'violationSourceAppFlow': 'Uygulama akışı',
    'violationSourceQueuedImport': 'Bildirime yanıt verilmedi',
    'violationTask': 'Görev',
    'violationTime': 'Zaman',
    'violationTypeDeferredStart': 'Görev başlangıcı ertelendi',
    'violationTypeDurationBarrierFailure':
        'Sigara arası süre bariyeri başarısız',
    'violationTypeFollowupDeferred': 'Takip yanıtı ertelendi',
    'violationTypeFollowupFailed': 'Takip başarısız işaretlendi',
    'violationTypeMandatoryGate': 'Zorunlu görev ekranı gösterildi',
    'violationTypeNoResponse10Min': 'Bildirime 10 dakika yanıt verilmedi',
    'violationTypeSuspiciousBehavior': 'Şüpheli hareket algılandı',
    'violationTypeWillpowerWeakness': 'Görev tamamlanmadı olarak işaretlendi',
    'weekly': 'Haftalık',
    ...
    'sleepRoutineReportSleepDuration': 'Uyku süresi',
    'sleepRoutineReportEvidence': 'Gece boyunca {probes} uyku sinyali işlendi.',
    'sleepRoutineReportChargingProbes': 'Şarj sırasında yakalanan uyku sinyali: {count}',
  ...
  static const Map<String, String> _en = {
    ...
    'howItWorksSubtitle': 'Learn the important features of the app.',
    ...
    'aiChatMenuShare': 'Share',
    'aiChatMenuCopy': 'Create a copy',
    ...
    'aiChatDeveloperOnly': 'AI conversations are available in the developer build',
    ...
    'permissionWhyThisTooltip': 'Why is this permission needed?',
    ...
    'breathExerciseCardTitle': 'Breath Test',
    ...
    'violationSourceAppFlow': 'App flow',
    'violationSourceQueuedImport': 'Notification went unanswered',
    'violationTask': 'Task',
    'violationTime': 'Time',
    'violationTypeDeferredStart': 'Task start deferred',
    'violationTypeDurationBarrierFailure': 'Smoke-free duration barrier failed',
    'violationTypeFollowupDeferred': 'Follow-up response deferred',
    'violationTypeFollowupFailed': 'Follow-up marked unsuccessful',
    'violationTypeMandatoryGate': 'Mandatory task screen shown',
    'violationTypeNoResponse10Min': 'Notification unanswered for 10 minutes',
    'violationTypeSuspiciousBehavior': 'Suspicious movement detected',
    'violationTypeWillpowerWeakness': 'Task marked not completed',
