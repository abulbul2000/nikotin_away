...
class AppTexts {
  ...
  static const Map<String, String> _tr = {
    ...
    'watchdogViolationTitle': 'Nikotin Away İhlal',
    'watchdogViolationBody': '10 dakika yanıt yok. Görev ihlali kaydedildi: {taskTitle}',
    'watchdogForegroundChannel': 'Arka plan servisi',
    'watchdogViolationChannel': 'Nikotin Away İhlal Uyarıları',
    ...
    'taskOverlayChannelDescription': 'Zorunlu görev ekranı gösterilirken aktif',
  ...
  static const Map<String, String> _en = {
    ...
    'watchdogViolationTitle': 'Nikotin Away Violation',
    'watchdogViolationBody': 'No response for 10 minutes. Task violation recorded: {taskTitle}',
    'watchdogForegroundChannel': 'Background service',
    'watchdogViolationChannel': 'Nikotin Away Violation Alerts',
    ...
    'taskOverlayChannelDescription': 'Active while the mandatory task screen is showing',
